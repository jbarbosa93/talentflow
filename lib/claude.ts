...
- date_naissance : CHERCHER ATTENTIVEMENT dans tout le document (coordonnées, infos personnelles, en-tête, pied de page, etc.). Formats courants à détecter : "30/12/1988", "30-12-1988", "30.12.1988", "1988-12-30", "36/ 30-12-1988" (âge/ date), "Né(e) le 30/12/1988", "Date de naissance: 30/12/1988", "DN: 30/12/1988", "36 ans (30/12/1988)", icône calendrier suivi d'une date. CAS FRÉQUENT SUR CV SUISSES : une date isolée DD.MM.YYYY ou DD/MM/YYYY dans la section coordonnées/informations personnelles (sans aucun label) est la date de naissance → la retourner. Retourner dans 4 cas : (1) date exacte trouvée → "30/12/1988" format DD/MM/YYYY ; (2) année de naissance seulement → "1988" ; (3) âge actuel de la PERSONNE uniquement (ex: "41 ans", "âge : 35", "a 35 ans", "35 ans" isolé dans section contact/infos perso) → retourner le chiffre seul ex: "41" ou "35" ; (4) aucune info → "". CAS FRÉQUENT FR : "Permis B + Véhicule 35 ans" ou "Permis B, 35 ans" dans la section contact = la personne a 35 ans → retourner "35". ATTENTION CRITIQUE : "X ans d'expérience", "X années d'expérience professionnelle" = durée de carrière, JAMAIS l'âge de la personne → ne pas utiliser pour date_naissance
