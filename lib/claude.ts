...
- localisation : ADRESSE DE RÉSIDENCE de la personne (où elle habite). Chercher EN PRIORITÉ une adresse en Suisse ou en France via ses indices : NPA (suisse = 4 chiffres ex 1870, français = 5 chiffres ex 74500), rue, ville — dans l'en-tête, les coordonnées, le pied de page. ⚠️ NE JAMAIS prendre la NATIONALITÉ, le PAYS D'ORIGINE, le LIEU DE NAISSANCE ni une langue comme localisation : si le CV indique une origine étrangère (ex "Brésilien", "originaire du Portugal") MAIS donne une adresse/NPA en Suisse ou France → retourner CETTE adresse suisse/française, jamais le pays d'origine. Formats courants : "1873 Val D'Illiez", "Rue XX 12, 1950 Sion", "Genève". Inclure le NPA si présent (ex: "1873 Val D'Illiez, Suisse"). Si seul le NPA est visible sans ville, utiliser "NPA Suisse". Si la personne réside RÉELLEMENT à l'étranger et que tu en es certain → "Ville, Pays". Si tu n'es PAS certain de l'adresse étrangère → mettre juste le pays, ou "". Si aucune localisation trouvée → ""
...
- genre : "M" pour homme, "F" pour femme. UNIQUEMENT si mention EXPLICITE dans le CV : "M." / "Mme" / "Monsieur" / "Madame" / "Né le" / "Née le" / accord grammatical SANS ambiguïté dans le texte (ex: "je suis motivée" → F, "je suis motivé" → M). NE JAMAIS déduire depuis le prénom seul (un prénom mixte ou ambigu = ""). Si le moindre doute → ""
- date_naissance : CHERCHER ATTENTIVEMENT dans tout le document (coordonnées, infos personnelles, en-tête, pied de page, etc.). Formats courants à détecter : "30/12/1988", "30-12-1988", "30.12.1988", "1988-12-30", "36/ 30-12-1988" (âge/ date), "Né(e) le 30/12/1988", "Date de naissance: 30/12/1988", "DN: 30/12/1988", "36 ans (30/12/1988)", icône calendrier suivi d'une date. CAS FRÉQUENT SUR CV SUISSES : une date isolée DD.MM.YYYY ou DD/MM/YYYY dans la section coordonnées/informations personnelles (sans aucun label) est la date de naissance → la retourner. Retourner dans 4 cas : (1) date exacte trouvée → "30/12/1988" format DD/MM/YYYY ; (2) année de naissance seulement, jour/mois ABSENTS du CV → retourner UNIQUEMENT l'année "1988" (NE JAMAIS inventer de jour/mois ni écrire "01/01" : un 01/01 inventé crée de faux doublons) ; (3) âge explicitement écrit avec le mot "ans" : "41 ans", "35ans", "âge : 35 ans", "a 35 ans", "Permis B + Véhicule 35ans", "Permis B, 35 ans" → retourner avec le suffixe ans ex: "41ans" ou "35ans" (JAMAIS un chiffre seul sans "ans") ; (4) aucune info → "". ATTENTION CRITIQUE : "X ans d'expérience", "X années d'expérience professionnelle", "X ans d'exp" = durée de carrière, JAMAIS l'âge de la personne → ne pas utiliser. Un chiffre isolé sans le mot "ans" collé = ne pas utiliser.
