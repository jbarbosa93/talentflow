...
import { Sparkles, CheckCircle, XCircle, Loader2, ArrowRight, Pause, Play, Square, History, Phone, MessageSquare, Mail, X, Smartphone, MessageCircle, Users, Copy, Check } from 'lucide-react'
      ...
      >
        ...
        {mode === 'individuel' ? (
          ...
          <div style={{ overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            {/* Liste candidats ligne par ligne */}
              ...
              {avecTel.map(c => {
                ...
                return (
                  <div key={c.id} style={{
                    ...
                    opacity: isOpened ? 0.5 : 1, transition: 'opacity 0.2s',
                  }}>
                    <AvatarWithFallback prenom={c.prenom} nom={c.nom} photo_url={c.photo_url} />
                    <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <a
                      ...
                      style={{
                        ...
                        background: isOpened ? 'var(--secondary)' : '#3B82F6',
                        color: isOpened ? 'var(--muted)' : 'white',
