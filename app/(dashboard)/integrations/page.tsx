    ...
    <div className="d-page" style={{ maxWidth: 860, paddingBottom: 60 }}>
      ...
      <div className="d-page-header" style={{ marginBottom: 24 }}>
        <div>
          ...
          <p className="d-page-sub">Connectez vos outils — sync automatique et envois</p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div data-section="onedrive" className="neo-card" style={{
...
// ─── v1.9.127 — Card V2 vue d'ensemble intégrations ─────────────────────────

function IntegrationCardV2({
  name, description, icon, color, bg, connected, status, onClick,
}: {
  name: string
  description: string
  ...
  return (
    <div
      ...
      style={{
        ...
        border: connected ? '1px solid rgba(16,185,129,0.45)' : '1px solid var(--border)',
        borderRadius: 14,
        padding: '16px 18px',
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
        ...
        <span style={{
          ...
          background: connected ? 'rgba(16,185,129,0.12)' : 'var(--secondary)',
          color: connected ? '#059669' : 'var(--muted)',
          border: `1px solid ${connected ? 'rgba(16,185,129,0.30)' : 'var(--border)'}`,
        }}>
          <span style={{
            width: 6, height: 6, borderRadius: '50%',
            background: connected ? '#10B981' : 'var(--muted)',
          }} />
      ...
      <div style={{ fontSize: 11, color: 'var(--muted-foreground)', marginTop: 'auto', paddingTop: 4, borderTop: '1px dashed var(--border)' }}>
        {status}
      </div>
    </div>
  )
